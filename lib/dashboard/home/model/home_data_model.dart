...
class HomeDataModel {
  ...
  factory HomeDataModel.fromJson(Map<String, dynamic> json) => HomeDataModel(
      ...
      eventsInviteList: json["events_invite_list"] == null
          ? []
          : List<EventsInviteList>.from(json["events_invite_list"]!
              .map((x) => EventsInviteList.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "events_invite_list": eventsInviteList == null
            ? []
            : List<dynamic>.from(eventsInviteList!.map((x) => x.toJson())),
...
class EventsInviteList {
  ...
  factory EventsInviteList.fromJson(Map<String, dynamic> json) =>
      EventsInviteList(
        ...
        eventAdmins: json["event_admins"] == null
            ? []
            : List<EventAdmin>.from(
                json["event_admins"]!.map((x) => EventAdmin.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "event_admins": eventAdmins == null
            ? []
            : List<dynamic>.from(eventAdmins!.map((x) => x.toJson())),
      };
}
